...
class CantStopGame:
    def __init__(self, nb_players: int):
        ...
        self.won = False
        self.steps = 0
        self.current_decision = "pairs"
        self.current_chosen_decision = 1
    ...
    def prompt_continue_training(self):
        self.current_decision = "continue"
        self.current_actions = [0, 1]
